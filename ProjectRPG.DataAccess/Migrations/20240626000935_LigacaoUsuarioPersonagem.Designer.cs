...
namespace ProjectRPG.DataAccess.Migrations
{
    ...
    [Migration("20240626000935_LigacaoUsuarioPersonagem")]
    partial class LigacaoUsuarioPersonagem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectRPG.Models.Arma", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ArmaPersonagem", b =>
                {
                    b.HasOne("ProjectRPG.Models.Arma", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ProjectRPG.Models.RPGUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ProjectRPG.Models.Personagem", b =>
                {
                    b.HasOne("ProjectRPG.Models.RPGUser", "Usuario")
