...
namespace ProjectRPG.Web.Areas.Identity.Pages.Account
{
    ...
    public class ResendEmailConfirmationModel : PageModel
    {
        ...
        public ResendEmailConfirmationModel(UserManager<RPGUser> userManager, IEmailSender emailSender)
        {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            StatusMessage = "Verifique seu e-mail para confirmar sua conta.";
            return Page();
        }
    }
}
